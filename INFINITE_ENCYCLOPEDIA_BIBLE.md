...
- **First Principle: Connection over Information**: Every node should make the user say, "I didn't know that connected to this." The magic lies in the connections, revealing that reality is deeply interconnected. For example: *Sun → Atmosphere → Blue Sky → Rayleigh Scattering → Photon → Electromagnetic Wave → Quantum Electrodynamics → Laser → Fiber Optics → Internet → The Infinite Encyclopedia itself.*
- **Traversing Reality**: The user should stop feeling like they're traversing information and start feeling like they're traversing *reality itself*. This is the soul of the project.
...
## 2. Changing Scales of Reality (Zooming as Paradigm Shift)
The encyclopedia isn't just about moving the camera; it's about changing scales of reality. This is sacred.

When you transition:
*Universe → Galaxy → Solar System → Earth → Forest → Tree → Leaf → Cell → Protein → Atom → Electron → Wave Function*

The transition shouldn't just feel like a camera move or scaling down to a "smaller Earth." It should feel like reality itself changes meaning. Going from Earth to Forest is a completely different way of perceiving reality. The physics, the rules, and the visual language completely transform at each boundary.

## 3. What the Infinite Encyclopedia Is and Is Not
**It IS:**
...
## 5. Fractal Knowledge Architecture
...
## 7. Gaussian Splats / 3D Environment Usage
...
## 9. Curiosity Paths and Natural Learning Trails
...
## 10. Zooming, Portals, Transitions, and Scale Shifts
...
## 13. Educational Psychology & "Show, Don't Tell"
...
## 14. Visual Language and Readability
...
## 15. Accessibility and Low-End Hardware Strategy
...
## 17. Creator Tools and Procedural Pipelines
...
## 18. Content Governance, Factual Reliability, and Versioning
...
## 19. Licensing and Asset Provenance
...
## 20. Technical Architecture Recommendations
...
## 21. Performance and Streaming Strategy
...
## 23. Risks, Failure Modes, and Anti-Patterns
...
## 25. Implementation Notes & Next Tasks
